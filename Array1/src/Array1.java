...
public class Array1 {
	...
	public static void main(String[] args) {
		//Array : 배열이란? 나열된 data 형태를 말한다.
		/*
		 * 배열기호는 다음과 같습니다 [ ], { }
		 */
		
		int a[] = new int [4]; //a[] 변수이지만 배열값을 받는 변수
//		new int[4] : 새롭게 숫자로 된 4개의 data를 생성함.
		a[0] = 5; // 배열은 무조건 0 부터
		a[1] = 15;
		a[2] = 25;
		a[3] = 35;
		// new int[배열범위] : 해당 범위는 실제 data 보다 무조건 커야함.
...
//				System.out.println(user[w]);
			...
			// int [] z : 배열값을 선언하고 해당 data를 직접적으로 자동 구분하여 적
...
//				System.out.print(z[ww] + " ");
			...
			//버전이 변경되면서 a[] 배열값 {}으로 인식시킬수있도록 변화됨.

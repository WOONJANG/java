...
//		mb2.lists();	//인스턴스에 있는 메소드를 로드하게 됨.
		
//		Member2.list3("유관순", 123456);
		
		/*[응용문제]
		 * for_in 이라는 일반 메소드(메모리)가 있습니다.
...
/*
	...
	public static void lists2 () { //static 메모리에 할당을 하고 메소드 함수 선언.
		String a = "이순신";
		System.out.println(a);
	}
	
	public static void list3(String nm, int pw) {
		//nm을 메소드에서 전달 받는 값을 바로 사용 할 경우 (nm.equals("유관순")) 
		
		
		
		int user_pw = pw;	//메소드에 객체값을 첨부하여 load 후 메소드 안에 별도의 필드명을 이용하여 전달 받는 형식.
